...
// Note the ?url suffix
import heroPath from './assets/img/Solaria Demo Pack Update 03/Solaria Demo Pack Update 03/16x16/Sprites/Hero 01.png?url';
import tilesetPath from './assets/img/Solaria Demo Pack Update 03/Solaria Demo Pack Update 03/16x16/Tilesets/Solaria Demo Update 01.png?url';
import tmxPath from './assets/res/first-level.tmx?url';
import tsxPath from './assets/res/tileset.tsx?url';
